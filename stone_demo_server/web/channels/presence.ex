defmodule StoneDemoServer.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule StoneDemoServer.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :stone_demo_server,
                        pubsub_server: StoneDemoServer.PubSub
end
